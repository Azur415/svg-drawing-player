...
const svg='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 700"><rect width="1000" height="700" fill="#eee9db"/><g id="details"><path d="M100 100 Q120 40 160 100 C190 130 110 160 100 100Z" fill="#a03d32"/><path d="M800 500 Q820 440 860 500 C890 530 810 560 800 500Z" fill="#a03d32"/></g></svg>';
...
test('camera follows within one layer, eases, respects manual/overview, and mini-map toggles',async({page})=>{
  await expect(page.locator('#cameraModeTrigger')).toContainText('Follow drawing');
